...
module.exports = {
    ...
    aliases: ['stat', 'me'],
    category: 'Yetkili',
    usage: '<@Noâ/ID> [günlük / haftalık / aylık / tümzamanlar]', 
    staff: true,
    guildOnly: true,
    cooldown: 3,
...
\`•>\` Şimdiye Kadar Toplam Kayıtsıza Atma Sayı : **${userData.unregister}**
            ...
            } else return message.channel.error(message, Embed.setDescription(`${mark ? mark : ``} Doğru kullanım : \`${Prefix}stats <@Noâ/ID> [günlük / haftalık / aylık / tümzamanlar]\``), { timeout: 10000, react: true });
